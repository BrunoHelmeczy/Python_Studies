...
# Course Repo: https://github.com/gutfeeling/univariate-linear-regression

# 1) Basics
# 1.1) Who bother ?

# 1.2) write a simple test
# test packages: pytest, unittest, nosetests, doctest
# used here: pytest 
    # (use py -m pip install pytest bash command)
